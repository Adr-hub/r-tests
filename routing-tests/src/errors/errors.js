import { useRouteError, Link, useHref } from "react-router-dom";
...
const Errors = () => {
    ...
    return <>
        ...
        <p className="fr-notification">Ce site peut avoir des défauts. Si ce message apparait vous pouvez rejoindre la <Link to={url}>page d'accueil</Link> du site.
        </p>
